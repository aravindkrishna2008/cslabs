    ...
    implements Iterable<E>
{
    ...
    {
        // Complete method
        return new MyTreeSetIterator(root); // Fix this!!
    }
    ...
    private TreeNode<E> removeRoot(TreeNode<E> root)
    {
        ...
        else
        {
            ...
            root.setValue(value);
            root.setRight(remove(right, value));
            return root;
        }
    ...
    {
        private Stack<TreeNode<E>> stackOfTreeNodes;

        private TreeNode<E>        tNode;

        public MyTreeSetIterator(TreeNode<E> root)
        {
            stackOfTreeNodes = new Stack<TreeNode<E>>();
            tNode = root;

            while (tNode != null)
            {
                stackOfTreeNodes.push(tNode);
                tNode = tNode.getLeft();
            }
        }
        ...
        {
            return !stackOfTreeNodes.isEmpty();
        }


        public E next()
        {
            if (stackOfTreeNodes.isEmpty())
            {
                throw new NoSuchElementException();
            }

            tNode = stackOfTreeNodes.pop();
