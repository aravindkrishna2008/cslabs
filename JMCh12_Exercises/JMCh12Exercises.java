...
public class JMCh12Exercises
{
    ...
    {
        char[] arr = { 'r', 'r', 'r', 's', 's', 's', 's', 's', 'p', 'p', 'p', 'p', 'p', 's' };
        char value = arr[(int)(Math.random() * 14)];
    ...
    public void filter(ArrayList<Object> list1, ArrayList<Object> list2)
    {
        ...
        for (int i = list1.size() - 1; i >= 0; i--)
        {
            ...
            {
                System.out.println(list1.get(i) + " " + list2.get(k) + " " + i + " " + k);
    ...
    public boolean isMedian(double[] sample, double m)
    {
        ...
        return numGreater == numLess;  // TODO fix this!!
    }
    ...
    public static double averageTopTwo(int[] scores)
    {
        ...
        System.out.println("iMax1 = " + iMax1 + " iMax2 = " + iMax2);
    ...
    public static boolean covers(double[][] m1, double[][] m2)
    {
        ...
        for (int i = 0; i < m1.length; i++)
        {
            ...
            {
                totalElements++;
                System.out.println(m1[i][k] + " " + m2[i][k]);
                if (m1[i][k] > m2[i][k])
                {
                    totalBigger++;
                }
        ...
        return totalBigger / ((double)totalElements) >= 0.5;   // TODO fix
                                                               // this!!
    }
            ...
            if (response.length() > 0)
            {
                ...
                switch (response.charAt(0))
                {
                    ...
                    case '3':
                        ...
                        System.out
                            .println("prob2abcdTrueFalse() --> " + Arrays.toString(prob2abcdAns));
                        break;
                    case '4':
                        int[] arr = { 1, 3, 2, 4 };
                    ...
                    case '6':
                        ...
                        System.out.println(
                            "odds = " + Math.round(odds[0] * TOTAL_RPS / ITER) + ":"
                    ...
                    case 'a':
                        String word = "abcd";
                        System.out
                            .println("computeScore(" + word + ") = " + exercise.computeScore(word));
                        break;
                    case 'B':
                    case 'b':
                    ...
                    case 'g':
                        ...
                        double median = 5.6;
                        System.out.println(
                            "isMedian(" + Arrays.toString(sample) + ", " + median + ") = "
                                + exercise.isMedian(sample, median));
                        System.out.println(
                            "isMedian(" + Arrays.toString(sample) + ", " + (median - 1) + ") = "
