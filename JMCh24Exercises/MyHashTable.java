...
public class MyHashTable
{
    ...
    /**
     * Question 24-22 Fill in the blanks in the add method. Adds the specified
     * element to this set if it is not already present. More formally, adds the
     * specified element str to this table if this tables does not contain the
     * element. If this set already contains the element, the call leaves the
     * table unchanged.
     * 
     * @param str
    ...
    {
        if (numItems >= loadFactorLimit * buckets.size())
        {
